...
export class FilterAuditPipe implements PipeTransform {
  ...
  transform(value: any, arg: any) {
    ...
    for (const object of value) {
      if (String(object.fechaHora).indexOf(arg) > -1
        ...
        || String(object.fechaHoraCreado).indexOf(arg) > -1
        ...
        || String(object.fechaHoraFinalizado).indexOf(arg) > -1
        ...
        || String(object.fechaHoraAsignadoTrabajador).indexOf(arg) > -1
